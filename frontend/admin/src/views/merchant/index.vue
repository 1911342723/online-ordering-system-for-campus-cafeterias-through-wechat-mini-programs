      ...
      <template #header>
        <div class="card-header">
          ...
          <div class="header-right">
            ...
            <el-badge :value="pendingCount" :hidden="pendingCount === 0" class="badge-item" style="margin-right: 12px;">
              <el-button type="warning" plain icon="DocumentChecked" @click="showPendingList">
                待审核
              </el-button>
            </el-badge>
