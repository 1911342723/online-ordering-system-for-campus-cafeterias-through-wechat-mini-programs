      ...
      <el-aside width="240px" class="layout-aside">
        ...
        >
          ...
          <template v-if="isMerchant && !isAdmin">
            <div class="menu-group-title">订单与菜品</div>
            ...
            <div class="menu-group-title">客户服务</div>
            ...
            <div class="menu-group-title">店铺与设置</div>
...
// 判断用户角色
// 商家端系统默认都是商家用户，除非明确标识为管理员
const isAdmin = computed(() => {
  // 只有username严格等于'admin'的才是管理员
  ...
  try {
    if (userInfo.id) {
      ...
      if (res.code === 1 && res.data) {
        ...
        // 连接WebSocket
        orderWebSocket.connect(merchantId)
        
        // 监听新订单事件
        orderWebSocket.on('newOrder', (orderData) => {
